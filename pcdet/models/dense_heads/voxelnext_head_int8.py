...
from ...utils.spconv_brevitas import QuantSubMConv2d

class SeparateHeadQuant(nn.Module):
    def __init__(self, input_channels, sep_head_dict, kernel_size, init_bias=-2.19, use_bias=False, weight_quant = None, act_quant = None, output_quant = None):
        super().__init__()
        ...
        for cur_name in self.sep_head_dict:
            ...
            if 'hm' in cur_name:
                ...
                for m in fc.modules():
                    if isinstance(m, (spconv.SubMConv2d, QuantSubMConv2d)):
...
class VoxelNeXtHeadInt8(nn.Module):
